...
public class PoisonousAreaAbility extends BaseTogglableAbility {
    ...
    public NamespacedKey getKey() {
        return new NamespacedKey(JustRaces.NAMESPACE, "poisonous_area");
    }
    ...
    public void enable(Player player) {
        ...
        BukkitTask task = new PoisonousAreaAbilityRunnable(this, config, pid).runTaskTimer(JustRaces.INSTANCE, 0, config.effectDuration);
