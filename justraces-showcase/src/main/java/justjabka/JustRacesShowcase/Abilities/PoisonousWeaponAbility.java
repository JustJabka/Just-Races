...
import justjabka.JustRacesShowcase.Configs.Ability.PoisonousWeaponAbilityConfig;
import justjabka.JustRacesShowcase.DataProvider.EnchantmentProvider;
...
public class PoisonousWeaponAbility extends BaseAbility {
    ...
    public NamespacedKey getKey() {
        return new NamespacedKey(JustRacesShowcase.NAMESPACE, "poisonous_weapon");
    }
