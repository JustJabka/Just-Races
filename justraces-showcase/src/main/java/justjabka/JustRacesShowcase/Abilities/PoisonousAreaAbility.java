...
import justjabka.JustRacesShowcase.Configs.Ability.PoisonousAreaAbilityConfig;
import justjabka.JustRacesShowcase.JustRacesShowcase;
import justjabka.JustRaces.Managers.AbilityManager;
import justjabka.JustRacesShowcase.Runnables.Ability.PoisonousAreaAbilityRunnable;
...
public class PoisonousAreaAbility extends BaseTogglableAbility {
    ...
    public NamespacedKey getKey() {
        return new NamespacedKey(JustRacesShowcase.NAMESPACE, "poisonous_area");
    }
    ...
    public void enable(Player player) {
        ...
        BukkitTask task = new PoisonousAreaAbilityRunnable(this, config, pid).runTaskTimer(JustRacesShowcase.INSTANCE, 0, config.effectDuration);
