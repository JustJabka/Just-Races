...
import justjabka.JustRacesShowcase.Configs.Ability.WeightlessWillowSwayAbilityConfig;
...
public class WeightlessWillowSwayAbility extends BaseAbility {
    ...
    public NamespacedKey getKey() {
        return new NamespacedKey(JustRacesShowcase.NAMESPACE, "weightless_willow_sway");
    }
