...
public class StageAbility extends BaseValidationAbility {
    public static final NamespacedKey STAGE_ABILITY_KEY = new NamespacedKey(JustRacesShowcase.NAMESPACE, "stage");
    ...
    public void giveStage(Player player) {
        ...
        Bukkit.getScheduler().runTaskLater(JustRacesShowcase.INSTANCE, () -> clearStage(player), duration);
    }
