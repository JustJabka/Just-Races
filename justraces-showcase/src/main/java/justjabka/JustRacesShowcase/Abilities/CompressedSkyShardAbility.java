...
import justjabka.JustRacesShowcase.Configs.Ability.CompressedSkyShardAbilityConfig;
...
public class CompressedSkyShardAbility extends BaseAbility {
    ...
    public NamespacedKey getKey() {
        return new NamespacedKey(JustRacesShowcase.NAMESPACE, "compressed_sky_shard");
    }
