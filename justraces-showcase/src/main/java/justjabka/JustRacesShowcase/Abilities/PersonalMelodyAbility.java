...
public class PersonalMelodyAbility extends BaseAbility {
    public static final NamespacedKey PERSONAL_MELODY_ABILITY_KEY = new NamespacedKey(JustRacesShowcase.NAMESPACE, "personal_melody");
    ...
    public void markBuffed(Player player) {
        ...
        Bukkit.getScheduler().runTaskLater(JustRacesShowcase.INSTANCE, () -> unmarkBuffed(player), duration);
    }
