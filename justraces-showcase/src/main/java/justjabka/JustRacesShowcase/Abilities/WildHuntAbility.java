...
import justjabka.JustRacesShowcase.Configs.Ability.WildHuntAbilityConfig;
import justjabka.JustRacesShowcase.JustRacesShowcase;
import justjabka.JustRaces.Managers.AbilityManager;
import justjabka.JustRacesShowcase.Runnables.Ability.WildHuntAbilityRunnable;
...
public class WildHuntAbility extends BaseValidationAbility {
    ...
    public NamespacedKey getKey() {
        return new NamespacedKey(JustRacesShowcase.NAMESPACE, "wild_hunt");
    }
    ...
    public void giveAbility(Player attacker, Player victim) {
        ...
        new WildHuntAbilityRunnable(this, playerId, victimId).runTaskTimer(JustRacesShowcase.INSTANCE, 0, 20L);
    }
