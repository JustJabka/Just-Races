...
import static justjabka.JustRacesShowcase.DataProvider.RaceProvider.FETR;
...
public class FetrRaceRunnable extends BaseRaceRunnable {
    public static final NamespacedKey FETR_STATUS_KEY = new NamespacedKey(JustRacesShowcase.NAMESPACE, "fetr_status");
    ...
    private void updateStatus(Player player) {
        double statusUpdateRadius = getConfigDouble("status_update_radius");
